...
export class IconComponent {
  ...
  path = computed(() => {
    // Basic sanitization not needed as we control the source, but `bypassSecurityTrustHtml` usage is implicit in bindings in some contexts, 
    // but here we just bind innerHTML.
